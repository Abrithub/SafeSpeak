...
import { View, Text, TouchableOpacity, StyleSheet, Image, SafeAreaView, StatusBar, BackHandler } from 'react-native';
...
const MENU = [
  ...
  { icon: '🔍', label: 'Track My Case',   route: 'TrackCase' },
  { icon: '🤖', label: 'AI Support Chat', route: 'AIChat' },
    ...
    <View style={s.overlay}>
      ...
      <SafeAreaView style={s.drawer}>
        ...
        <View style={s.footer}>
          ...
          <TouchableOpacity style={s.quickExit} onPress={() => BackHandler.exitApp()}>
            <Text style={s.quickExitText}>⚡ Quick Exit</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </View>
...
const s = StyleSheet.create({
  ...
  quickExit: { backgroundColor: '#ef4444', marginTop: spacing.md, paddingVertical: 10, borderRadius: radius.full, alignItems: 'center' },
  quickExitText: { color: '#fff', fontWeight: 'bold', fontSize: font.sm },
});
